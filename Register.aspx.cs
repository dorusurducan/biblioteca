...
namespace Bibliotheque
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        {
            this.Form.DefaultButton = this.register.UniqueID;
            username.Focus();
        }
        ...
        protected void ButtonRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ((Label)(Master.FindControl("lblMessage"))).Text = "The password is not the same ";
                ...
                commande.Parameters.Add("@rol", SqlDbType.NVarChar).Value = usersrols.SelectedItem.Value;
                ...
                ((Label)(Master.FindControl("lblMessage"))).Text = "User added succesfully !";
            ...
            catch (Exception ex)
            {
                ...
                ((Label)(Master.FindControl("lblMessage"))).ForeColor = System.Drawing.Color.Red;
                ((Label)(Master.FindControl("lblMessage"))).Text = "User not added !";
            }
